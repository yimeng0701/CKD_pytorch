...
class ModelSaverBase(object):
    ...
    * `_rm_checkpoint
    ...
    def __init__(self, base_path, model, model_opt, fields, optim,
                 keep_checkpoint=-1, train_config={}):
    ...
    def save(self, step, moving_average=None, metrics={}):
        ...
        chkpt, chkpt_name = self._save(step, save_model, metrics)
    ...
    def _save(self, step, save_model, metrics):
...
class ModelSaver(ModelSaverBase):
    ...
    def _save(self, step, model, metrics):
        ...
        logger.info("Saving checkpoint %s_%d.pt" % (self.base_path, step))
        checkpoint_path = '%s_%d.pt' % (self.base_path, step)
